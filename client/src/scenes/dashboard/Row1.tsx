  ...
  return (
    ...
    <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <YAxis tickLine={false} axisLine={{strokeWidth:"0px"}} style={{fontSize:"10px"}} domain={[8000,23000]}/>
          <Tooltip />
    ...
    <BoxHeader title='Profits and Revenue' subtitle='Top Line represents Revenue, Bottom Line represents Profits' sideText='+4%' />
    <ResponsiveContainer width="100%" height="100%">
        <LineChart
          data={revenueProfit}
          margin={{
